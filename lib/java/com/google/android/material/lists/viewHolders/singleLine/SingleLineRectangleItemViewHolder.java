...
/**
 * A single-lined ViewHolder with a rectangular image, one line of text and an action
 */
public class SingleLineRectangleItemViewHolder extends MaterialViewHolder {

  public ShapeableImageView visual;
  public TextView primaryText;
  public FrameLayout secondaryAction;

  public SingleLineRectangleItemViewHolder(@NonNull ViewGroup parent) {

    super(R.layout.single_line_rectangle_item, parent, R.dimen.material_list_item_inset_position_rectangle);
