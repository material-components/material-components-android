...
/**
 * A two-lined ViewHolder with a square image, title text, one line of subtext and an action
 */
public class TwoLineSquareItemViewHolder extends MaterialViewHolder {
  ...
  public TwoLineSquareItemViewHolder(@NonNull ViewGroup parent) {

    super(R.layout.two_line_square_item, parent, R.dimen.material_list_item_inset_position_icon);
