...
/**
 * A three-lined ViewHolder with a rectangular image, title text, two lines of subtext and an action
 */
public class ThreeLineRectangleItemViewHolder extends MaterialViewHolder {
  ...
  public ThreeLineRectangleItemViewHolder(@NonNull ViewGroup parent) {

    super(R.layout.three_line_rectangle_item, parent, R.dimen.material_list_item_inset_position_rectangle);
