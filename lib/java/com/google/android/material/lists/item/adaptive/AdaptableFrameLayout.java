...
public class AdaptableFrameLayout extends FrameLayout implements AdaptableView<Boolean> {

  AdaptableVisibility<Boolean> adaptableVisibility = new AdaptableVisibility<>(this, this);

  public AdaptableFrameLayout(@NonNull Context context) {
    this(context, null);
  }

  public AdaptableFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public AdaptableFrameLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
