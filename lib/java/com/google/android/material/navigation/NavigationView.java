...
public class NavigationView extends ScrimInsetsFrameLayout implements MaterialBackHandler {
  ...
  private void initItemBackgrounds(@NonNull Context context, @NonNull TintTypedArray a) {
    ...
    if (itemBackground == null && hasShapeAppearance(a)) {
      ...
      itemShapeFillColor = MaterialResources.getColorStateList(
          context, a, R.styleable.NavigationView_itemShapeFillColor);

      itemRippleColor = MaterialResources.getColorStateList(
  ...
  private void updateItemBackground() {
    if (itemBackground != null) {
      ...
      final int itemShapeInsetLeft = layoutDirection == View.LAYOUT_DIRECTION_LTR
          ? itemShapeInsetStart
          : itemShapeInsetEnd;

      final int itemShapeInsetRight = layoutDirection == View.LAYOUT_DIRECTION_LTR
          ? itemShapeInsetEnd
          : itemShapeInsetStart;

      final MaterialShapeDrawable itemShapeDrawable = new MaterialShapeDrawable(shapeAppearanceModel);
  ...
  private void updateItemForeground() {
    if (shapeAppearanceModel != null) {
      ...
      final RippleDrawable itemRippleDrawable =
          new RippleDrawable(
              RippleUtils.sanitizeRippleDrawableColor(itemRippleColor),
              null,
              itemRippleMaskDrawable);
