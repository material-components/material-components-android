 ...
 *
 * <p>You shouldn't not instantiate this directly. Instead use {@code ViewUtils.createAnimator()}.
 */
class ValueAnimatorCompat {
  ...
  interface AnimatorListener {
    ...
    /**
     * Notifies the cancellation of the animation. This callback is not invoked for animations with
