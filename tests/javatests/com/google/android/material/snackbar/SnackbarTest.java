...
public class SnackbarTest {
  ...
  //
  // @Test
  // public void testSnackbar_consumesClicks_whenEnable() throws Throwable {
  //   final Snackbar snackbar =
  //       Snackbar.make(coordinatorLayout, MESSAGE_TEXT, Snackbar.LENGTH_INDEFINITE)
  //           .setAction(ACTION_TEXT, mock(View.OnClickListener.class));
  //   final BaseTransientBottomBar.BaseCallback mockCallback1 =
  ...
  @Test
  public void testSnackbar_doesNotConsumeClicks() {
    final Snackbar snackbar =
        Snackbar.make(coordinatorLayout, MESSAGE_TEXT, Snackbar.LENGTH_INDEFINITE)
            .setAction(ACTION_TEXT, mock(View.OnClickListener.class));
    ...
    activity.runOnUiThread(new Runnable() {
      ...
      public void run() {
        ...
        checkBox.setLayoutParams(new CoordinatorLayout.LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT));
      }
    });
    ...
    Snackbar.CONSUMING_TOUCH_EVENTS = false;

    onView(withText(MESSAGE_TEXT)).perform(click());

    onView(withText("Test checkbox")).check(ViewAssertions.matches(isChecked()));
